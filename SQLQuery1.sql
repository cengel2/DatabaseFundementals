        ...
        *************************************** */
        ...
        (
            ...
            CustomerNumber int
				...
				-- PK constraints ensure a row oF data being added to the table
				-- will have to have a unique value for the PK column(s)
				CONSTRAINT PK_Customers_CustomerNumber
					PRIMARY KEY
					-- IDENTITY mean the database will generate a unique whole-number
...
INSERT INTO Customers(FirstName,LastName,[Address], City, Province, PostalCode)
	...
	INSERT INTO Orders(CustomerNumber, [Date], Subtotal, GST, Total)
		VALUES (100, GETDATE(), 17.45, 0.87, 20.00)